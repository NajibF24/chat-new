...
import { generateTokenReport } from './TokenReportPDF';
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex gap-2 flex-wrap items-end">
                ...
                {tokenStats && (
                  <button
                    onClick={() => generateTokenReport(tokenStats, bots, { from: tokenDateFrom, to: tokenDateTo })}
                    className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white text-xs font-semibold rounded-xl hover:from-emerald-700 hover:to-emerald-800 transition-all shadow-sm flex items-center gap-1.5 group"
                  >
